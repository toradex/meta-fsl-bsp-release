...
do_compile () {
    ...
    oe_runmake DCD_BOARD=colibri-imx8qxp -C iMX8QX -f soc.mak imx8qx_colibri-imx8qxp_dcd.cfg.tmp
}
...
do_deploy () {
    ...
    install -m 0644 ${S}/iMX8QX/imx8qx_colibri-imx8qxp_dcd.cfg.tmp ${DEPLOYDIR}
}
